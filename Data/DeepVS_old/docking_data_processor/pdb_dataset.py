...
class PDBDataset:
    ...
    def load(self, datasetFileName, moleculeCode, i):
        ''' 
        Loads the dataset
        ...
        #print("LOAD dataset file name and moleculeCode: ", datasetFileName, moleculeCode)
        ...
        while line:
            ...
            if (readingCode):
                ...
                #moleculeName = fin.readline().strip() # 1 line above is tripos molecule
                 # reading
            ...
            # if the ATOMS sections was found
                elif (line.startswith("@<TRIPOS>ATOM") or str(line).__contains__("UNL1")):
                    readingAtoms = True
                    readingBonds = False
                    #print(line)
...
#     inputFileName  = "../../deepbio-data/dockoutput/tk/virtual_flex_scored.mol2"
    inputFileName  = "../../ace_ligands_MMFF94_modified.mol2"
